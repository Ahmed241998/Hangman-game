...
* Creating a list of fruit names the program will pick a word from randomly.
...
* If he didnot get the word with available chances he has the program will let him that he consumed all chances and ask him if he wants to play again
